...
<div class="container invoice">
	<h1 class="product-title mb-4" style="margin-top: 100px;">Edit
		News</h1>
	<p style="margin-top: 70px; font-size: 150%; font-family: pushster">
		<strong>Author</strong>
	</p>
	<div class="media d-flex">
		<a class="pull-left" href="#"><img width="100px"
			class="media-object"
	...
	<div class="row">
		...
		<div class="col-md-10">
			...
			<form:form action="${updateNews}" method="POST" modelAttribute="news">
				<b>ID</b>
				<form:input path="id" readonly="true" class="form-control" rows="5" />
				<br />
				<br />

				<b>Author</b>
				<form:input path="author" readonly="true" class="form-control" rows="5" />
				<br />
				<br />

				<b>Date</b>
				<form:input path="date" readonly="true" class="form-control" rows="5" />
				<br />
				<br />
				
				<b>Title</b>
				<form:input path="title" class="form-control" rows="5" />
				<br />
				<br />
