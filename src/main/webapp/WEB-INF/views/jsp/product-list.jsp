			...
			<c:forEach var="product" items="${listProduct}">
				<div class="col">
					<div class="card h-100">
						<img
							src="https://media.thaythichtructhaiminh.com/files/nghien87/2021/05/05/am-thuc-le-hoi-hoa-cuc-1416.jpg"
							class="card-img-top" alt="...">
						<div class="card-body">
								...
								<thead>
									<tr>
										<th scope="col">
											...
											<p class="card-text">
												<a href="${urlView}/${product.id}">View Detail</a>
											</p>
										</th>
										<th scope="col"><c:url value="/updateCart"
												var="updateCart" />
											<form action="${updateCart}" method="get">
												ID: <input name="id" readonly="true" value="${product.id}" />
												<br /> <br /> Quantity: <input name="quan" type="text" /> <br />
												<br />
