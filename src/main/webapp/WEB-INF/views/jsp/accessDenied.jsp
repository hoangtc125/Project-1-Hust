...
<main style = "margin-top: 170px; margin-bottom: 300px;">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 align-self-center">
          ...
          <h2><strong>Sorry, you do not have permission to view this page.</strong></h2>
          <p>click <a href="/prj1.com">here</a> to go back to the Homepage.</p>
