...
<td> <a href="${urlUpdate}/${product.id}/${pageContext.request.userPrincipal.name}">Edit</a></td>
<td> <a href="${urlSoftDelete}/${product.id}/${pageContext.request.userPrincipal.name}">Delete</a></td>
</tr>
</c:forEach>
</c:if>
</table>
