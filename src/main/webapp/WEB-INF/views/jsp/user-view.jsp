		...
		<nav aria-label="breadcrumb" class="main-breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a
					href="<c:url value="/user-list?sort=" />">List user</a></li>
				...
				<div class="card mb-3">
					<div class="card-body">
						<div class="row">
							...
							<div class="col-sm-9 text-secondary">${user.mssv}</div>
						</div>
						<hr>
						<div class="row">
							<div class="col-sm-3">
						...
						<div class="row">
							...
							<div class="col-sm-9 text-secondary">${user.coin}VND</div>
						</div>
						<hr>
						<div class="row">
							<div class="col-sm-3">
							...
							<div class="col-sm-9 text-secondary">${user.clazz}</div>
						</div>
						<hr>
						<div class="row">
							<div class="col-sm-12">
		...
		<div class="card-body" style="margin-bottom: 70px;">
			...
			<div class="row row-cols-1 row-cols-md-3 g-4">
				...
				<c:if test="${empty listNews}">
					<p style="margin-top: 49px; font-size: 150%; text-align: center">
						<b><i>0 News to display</i></b>
					</p>
				</c:if>
							...
							<div class="card h-100">
								...
								<div class="card-body">
									...
									<ul
										...
										style="color: #AAAAAA; font-size: 12px; padding-right: 10px; font-weight: 600;">
										<li><i class="fa fa-calendar"></i>${news.date}</li>
									</ul>


									<div class="d-flex" style="margin-top: 20px">
										<h5 class="d-flex" style="margin-top: 7px;">Author:</h5>
										<h5>
