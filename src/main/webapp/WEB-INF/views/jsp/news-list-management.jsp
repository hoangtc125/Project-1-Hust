              ...
              <table class="table mb-0">
                <thead>
                  <tr>
                    ...
                    <th scope="col"><b>Title</b> <a href="news-list?sort=Title"><svg
				...
				<c:forEach var="news" items="${listNews}">
		                    <tr class="fw-normal">
		                        ...
		                        <td class="align-middle">
		                          ...
		                          <a href="${urlUpdate}/${news.id}/${pageContext.request.userPrincipal.name}" data-mdb-toggle="tooltip" title="Edit" style="margin-left: 7px;"><i class="fas fa-edit text-success"></i></a>
		                          <a href="${urlSoftDelete}/${news.id}/${pageContext.request.userPrincipal.name}" data-mdb-toggle="tooltip" title="Remove" style="margin-left: 7px;"><i class="fas fa-trash-alt text-danger"></i></a>
		                        </td>
		                      </tr>
		                     </c:forEach>
		                 </c:if>
